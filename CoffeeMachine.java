...
public class CoffeeMachine {
    ...
    /*****************************************************************
    * On the third stage, we need to inform the quantity of cups we want,
    * then the program will calculate how much coffee it can makes
    * and show us.
    *****************************************************************/
    static void requestSupply() {
        ...
        int beanSupply = scanner.nextInt();
        System.out.println("Write how many cups of coffee you will need: ");
        int cupQuantity = scanner.nextInt();

        waterSupply = waterSupply / 200;
        milkSupply = milkSupply / 50;
        beanSupply = beanSupply / 15;

        int minimum = Math.min(waterSupply, milkSupply); // To check the minimum amount of coffee that can be made.
        minimum = Math.min(beanSupply, minimum);         // To check the minimum amount of coffee that can be made.

        if (cupQuantity == minimum) {
            System.out.println("Yes, I can make that amount of coffee");
        } else if (cupQuantity < minimum) {
            System.out.println("Yes, I can make that amount of coffee (and even " +
                    (minimum - cupQuantity) + " more than that)");
        } else {
